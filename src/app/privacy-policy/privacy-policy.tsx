  ...
  return (
    <MainTemplate>
      <div className="container !max-w-[1000px] py-10 mb-[100px] relative z-20">
        ...
        <h2 className="font-bold mb-4">1. Общие положения </h2>
        ...
        <p>
          ...
          27.07.2006 № 152-ФЗ «О персональных данных» и регулирует порядок
          обработки и защиты персональных данных, осуществляемой владельцем
          веб-сайта{" "}
          <Link href="https://www.mir-darog.ru/" className="!underline">
            https://www.mir-darog.ru/
          </Link>{" "}
          (далее — Оператор).
        </p>

        <p className="mt-1">
          <b className="font-bold">1.1.</b> Оператор ставит своей важнейшей
        ...
        <p className="mt-1">
          <b className="font-bold">1.2.</b> Настоящая политика Оператора в
          отношении обработки персональных данных (далее — Политика) применяется
        ...
        <p className="mt-1">
          <b className="font-bold">2.1.</b> Автоматизированная обработка
          персональных данных — обработка персональных данных с помощью средств
          вычислительной техники.
        </p>

        <p className="mt-1">
          <b className="font-bold">2.2.</b> Блокирование персональных данных —
        ...
        <p className="mt-1">
          <b className="font-bold">2.3.</b> Веб-сайт — совокупность графических
        ...
        <p className="mt-1">
          <b className="font-bold">2.4.</b> Информационная система персональных
          данных — совокупность содержащихся в базах данных персональных данных
          и обеспечивающих их обработку информационных технологий и технических
          средств.
        </p>
        <p className="mt-1">
          <b className="font-bold">2.5.</b> Обезличивание персональных данных —
        ...
        <p className="mt-1">
          <b className="font-bold">2.6.</b> Обработка персональных данных —
        ...
        <p className="mt-1">
          <b className="font-bold">2.7.</b> Оператор — государственный орган,
        ...
        <p className="mt-1">
          <b className="font-bold">2.8.</b> Персональные данные — любая
        ...
        <p className="mt-1">
          <b className="font-bold">2.9.</b> Персональные данные, разрешенные
        ...
        <p className="mt-1">
          <b className="font-bold">2.10.</b> Пользователь — любой посетитель
          веб-сайта{" "}
          <Link href="https://www.mir-darog.ru/" className="!underline">
            https://www.mir-darog.ru/
          </Link>
        ...
        <p className="mt-1">
          <b className="font-bold">2.11.</b> Предоставление персональных данных
          — действия, направленные на раскрытие персональных данных
          определенному лицу или определенному кругу лиц.
        </p>
        <p className="mt-1">
          <b className="font-bold">2.12.</b> Распространение персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">2.13.</b> Трансграничная передача
        ...
        <p className="mt-1">
          <b className="font-bold">2.14.</b> Уничтожение персональных данных —
        ...
        <p className="mt-1">
          <b className="font-bold">3.1. </b> Оператор имеет право: <br />
        ...
        <p className="mt-1">
          <b className="font-bold">3.2. </b> Оператор обязан:
          <br />
          ...
          течение 10 дней с даты получения такого запроса; <br />
          ...
          данных; <br />— исполнять иные обязанности, предусмотренные Законом о
          персональных данных.
        </p>
        ...
        <p className="mt-1">
          <b className="font-bold">4.1. </b> Субъекты персональных данных имеют
          право:
          <br />
          ...
          данных в целях продвижения на рынке товаров, работ и услуг; <br />— на
          отзыв согласия на обработку персональных данных, а также, на
        ...
        <p className="mt-1">
          <b className="font-bold">4.2. </b> Субъекты персональных данных
          обязаны:
          <br />
        ...
        <p className="mt-1">
          <b className="font-bold">4.3. </b> Лица, передавшие Оператору
        ...
        <p className="mt-1">
          <b className="font-bold">5.1. </b> Обработка персональных данных
          осуществляется на законной и справедливой основе.
        </p>

        <p className="mt-1">
          <b className="font-bold">5.2. </b> Обработка персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">5.3. </b> Не допускается объединение баз
          данных, содержащих персональные данные, обработка которых
          осуществляется в целях, несовместимых между собой.
        </p>

        <p className="mt-1">
          <b className="font-bold">5.4. </b> Обработке подлежат только
          персональные данные, которые отвечают целям их обработки.
        </p>

        <p className="mt-1">
          <b className="font-bold">5.5. </b> Содержание и объем обрабатываемых
        ...
        <p className="mt-1">
          <b className="font-bold">5.6. </b> При обработке персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">5.7. </b> . Хранение персональных данных
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                материалам, содержащимся на вебсайте <br />
                <br />
                Консультирование по услугам, обработка заявок, обратная связь,
                аналитика, улучшение пользовательского опыта, соблюдение
                обязательств по договорам, информирование об услугах и акциях.
              </td>
            </tr>
            <tr>
        ...
        <p className="mt-1">
          <b className="font-bold">7.1. </b> Обработка персональных данных
          осуществляется с согласия субъекта персональных данных на обработку
          его персональных данных.
        </p>

        <p className="mt-1">
          <b className="font-bold">7.2. </b> Обработка персональных данных
          необходима для достижения целей, предусмотренных международным
          договором Российской Федерации или законом, для осуществления
          возложенных законодательством Российской Федерации на оператора
          функций, полномочий и обязанностей.
        </p>

        <p className="mt-1">
          <b className="font-bold">7.3. </b> Обработка персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">7.4. </b> Обработка персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">7.5. </b> Обработка персональных данных
        ...
        <p className="mt-1">
          <b className="font-bold">7.6. </b> Осуществляется обработка
        ...
        <p className="mt-1">
          <b className="font-bold">7.7. </b> Осуществляется обработка
        ...
        <p className="mt-1">
          <b className="font-bold">8.1. </b> Оператор обеспечивает сохранность
          персональных данных и принимает все возможные меры, исключающие доступ
          к персональным данным неуполномоченных лиц.
        </p>

        <p className="mt-1">
          <b className="font-bold">8.2. </b> Персональные данные Пользователя
          ...
          исполнения обязательств по гражданско-правовому договору. В том числе
          при привлечении третьих лиц, предоставляющих технические, хостинговые
          или аналитические услуги, при условии соблюдения ими требований
          законодательства в области персональных данных.
        </p>

        <p className="mt-1">
          <b className="font-bold">8.3. </b> В случае выявления неточностей в
          ...
          <Link href="mailto:maks.serobyan@mail.ru" className="!underline">
        ...
        <p className="mt-1">
          <b className="font-bold">8.4. </b> Срок обработки персональных данных
          определяется достижением целей, для которых были собраны персональные
          данные, если иной срок не предусмотрен договором или действующим
        ...
        <p className="mt-1">
          <b className="font-bold">8.5. </b> Вся информация, которая собирается
          ...
          данных обязан самостоятельно ознакомиться с пользовательскими
          соглашениями и политиками конфиденциальности указанных третьих лиц.
          Оператор не несёт ответственности за действия таких лиц. Оператор не
          несет ответственность за действия третьих лиц, в том числе указанных в
          настоящем пункте поставщиков услуг.
        </p>

        <p className="mt-1">
          <b className="font-bold">8.6. </b> Установленные субъектом
        ...
        <p className="mt-1">
          <b className="font-bold">8.7. </b> Оператор при обработке персональных
          данных обеспечивает конфиденциальность персональных данных.
        </p>

        <p className="mt-1">
          <b className="font-bold">8.8. </b> Оператор осуществляет хранение
        ...
        <p className="mt-1">
          <b className="font-bold">8.9. </b> Условием прекращения обработки
        ...
        <p className="mt-1">
          <b className="font-bold">9.1. </b> Оператор осуществляет сбор, запись,
        ...
        <p className="mt-1">
          <b className="font-bold">9.2. </b> Оператор осуществляет
          автоматизированную обработку персональных данных с получением и/или
          передачей полученной информации по информационнотелекоммуникационным
        ...
        <p className="mt-1">
          <b className="font-bold">10.1. </b> Оператор до начала осуществления
          деятельности по трансграничной передаче персональных данных обязан
        ...
        <p className="mt-1">
          <b className="font-bold">10.2. </b> Оператор до подачи вышеуказанного
        ...
        <h2 className="font-bold mt-6 mb-4">12. Заключительные положения</h2>

        <p className="mt-1">
          <b className="font-bold">12.1. </b> Пользователь может получить любые
        ...
        <h2 className="font-bold mt-6 mb-4">
          13. Использование файлов cookie и аналитики{" "}
        </h2>

        <p className="mt-1">
          Сайт использует файлы cookie и сервисы веб-аналитики (например,
          Яндекс.Метрика) для сбора обезличенной информации о действиях
          пользователей, что помогает улучшать качество предоставляемых услуг.
          Пользователь может отключить использование cookie в настройках своего
          браузера. Продолжая пользоваться сайтом, пользователь соглашается с
